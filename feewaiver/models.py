...
class FeeWaiver(RevisionedMixin):
    ...
    contact_details = models.OneToOneField(ContactDetails, related_name="fee_waiver", blank=True, null=True, on_delete=models.SET_NULL)
...
class FeeWaiverVisit(RevisionedMixin):
    fee_waiver = models.ForeignKey(FeeWaiver, related_name="visit", on_delete=models.CASCADE)
...
class FeeWaiverLogEntry(CommunicationsLogEntry):
    fee_waiver = models.ForeignKey(FeeWaiver, related_name='comms_logs', blank=True, null=True, on_delete=models.SET_NULL)
...
class FeeWaiverUserAction(UserAction):
    ...
    fee_waiver = models.ForeignKey(FeeWaiver, related_name='action_logs', blank=True, null=True, on_delete=models.SET_NULL)
