<template lang="html">
    ...
    <form id="feewaiver-form" @submit.prevent="submit">
        <div v-if="!isInternal" class="panel panel-default headerbox">
            <strong>
                <p>Welcome to the entry fee waiver request form. Entry fee waivers may be provided to certain groups undertaking organised outings in parks with entry fees managed by the Department of Biodiversity Conservation and Attractions (DBCA).</p>
